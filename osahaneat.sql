...
insert into restaurant(name,adderss,description,rating,content) values("McDonal","123HCM","Fast food",4,"Very Goof");
insert into category(name,description) values("Pizza", "Euro food");
insert into category(name,description) values("Chicken", "Euro food");
insert into category_restaurant(restaurant_id,category_id) values(1,1);
insert into category_restaurant(restaurant_id,category_id) values(1,2);
